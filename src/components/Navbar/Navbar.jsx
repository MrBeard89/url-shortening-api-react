      ...
      <div className='navbar-wrapper'>
        <div className='navbar-container'>
          <div className='header-logo-container'>
            ...
            <svg className='header-logo' xmlns='http://www.w3.org/2000/svg' viewBox=' 16 -35 95 75'>
              <path
                fill='#34313D'
          ...
          <span className='mobile-menu' onClick={() => setnavbarOpen((prev) => !prev)}>
            {navbarOpen ? <AiOutlineClose id='closemenu' /> : <GiHamburgerMenu id='burgermenu' />}
          </span>
          ...
          <div className={`navbar${navbarOpen ? ' show-menu' : ''}`}>
            ...
            <hr className='navbar-line-mobile' />
